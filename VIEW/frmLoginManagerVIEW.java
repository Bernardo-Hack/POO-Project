...
public class frmLoginManagerVIEW extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmLoginManagerVIEW frame = new frmLoginManagerVIEW();
	...
	public frmLoginManagerVIEW() {
		...
		JLabel lblNewLabel = new JLabel("Nome de usuario (gerente)");
	...
	private void Logar() {
		try {
			...
			ManagerDTO objusuariodto = new ManagerDTO();
			objusuariodto.setName(nome_usuario);
			objusuariodto.setSenha(senha_ususario);

			ManagerDAO objusuariodao = new ManagerDAO();
