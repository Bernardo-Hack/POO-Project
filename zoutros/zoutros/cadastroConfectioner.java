...
public class cadastroConfectioner extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					cadastroConfectioner frame = new cadastroConfectioner();
	...
	public cadastroConfectioner() {
		...
		JLabel lblCadastro = new JLabel("Cadastro de confeiteiro");
		lblCadastro.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblCadastro.setBounds(243, 11, 216, 21);
		contentPane.add(lblCadastro);
		
		JButton btnNewButton = new JButton("Cadastrar confeiteiro");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnNewButton.setBounds(280, 362, 159, 23);
